...
require "$ENV{MNIBASEPATH}/lib/surface-extraction/utils.pl";
require "$ENV{MNIBASEPATH}/lib/surface-extraction/deform_utils.pl";
...
#       from detaching from bottom of sulci.
    ...
    @schedule = (
      ...
      #----- ----  ----  ---  --    ---  ----  ---   ---  ----
       81920, 5e3 * $str_weight,  100, 50, 1.0,   1e1,  .25,   5,  1.0, 5e-3 * $lap_weight,
       81920, 5e3 * $str_weight,  200, 50, 1.0,   1e1,  .25,   5,  1.0, 2e-2 * $lap_weight,
       81920, 5e3 * $str_weight,  300, 50, 0.5,   1e1,  .25,   6,  1.0, 2e-2 * $lap_weight,
       81920, 5e2 * $str_weight,  300, 50, 0.5,   1e1,  .25,   7,  1.0, 2e-2 * $lap_weight,
       81920, 5e2 * $str_weight,  400, 50, 0.5,   1e1,  .25,   8,  1.0, 2e-2 * $lap_weight,
       81920, 5e2 * $str_weight,  500, 50, 0.5,   1e1,  .25,   9,  1.0, 2e-2 * $lap_weight,
       81920, 5e2 * $str_weight,  550, 50, 0.5,   1e1, .125, 9.5,  1.0, 2e-2 * $lap_weight,
       81920, 5e2 * $str_weight,  250, 50, 0.5,   1e1, .125,  10,  1.0, 2e-2 * $lap_weight,
       81920, 5e2 * $str_weight,  400, 50, 0.25,  1e1, .125,  10,  0.0, 5e-2 * $lap_weight,
       81920, 5e2 * $str_weight,  500, 50, 0.25,  1e1, .0625, 10,  0.0, 1e-1 * $lap_weight,
    );
